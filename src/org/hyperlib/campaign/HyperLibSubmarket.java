...
public class HyperLibSubmarket extends BaseSubmarketPlugin {
    public static float DEFAULT_TARIFF = -1f;  /// Defaults to parent market tariff.
    public static boolean DEFAULT_IN_ECONOMY = false;  /// Defaults to no participation in sector economy.
    public static String DEFAULT_MESSAGE = "You cannot trade this item with %s";
    public static String DEFAULT_NO_BUY = null;  /// By default, you can always buy.
    public static String DEFAULT_NO_SELL = null;  /// By default, you can always sell.

    protected transient boolean loadedJSON = false;  /// Has the JSON file been loaded this session?
    ...
    public @Nullable String getMessageNoBuy() { return messageNoBuy; }
    public @Nullable String getMessageNoSell() { return messageNoSell; }
    ...
    public String getDisplayName(String id) { return displayNamesMap.getOrDefault(id, id); }
    public Set<String> getLimitSet(Limit limit) { return limitMap.getOrDefault(limit, Set.of()); }

    protected transient Map<Items, List<Integer>> itemCountPerSize;  /// The number of items generated in a category given market size.
    protected transient Map<Items, Integer> itemCountStatic;  /// The number of items generated in a category.
    protected transient Map<Items, Integer> tierPerSize;  /// The tier of items generated given market siz.e
    protected transient Map<Role, Float> dpPerSize, dpStatic;  /// DP scaling for generated fleets.
    protected transient Map<Items, List<String>> itemsStatic;  /// Items always available for sale.
    protected transient Map<Items, Float> itemCullFraction;  /// This fraction of items in the category are culled.
    protected transient float tariff;  /// Tariff the player pays on purchases/sales.
    protected transient int shipQualityBonus;  /// Bonus to ship quality relative to parent market.
    protected transient boolean inEconomy;  /// Does this participate in the sector economy?
    protected transient String messageGeneric;  /// The 'none of the above' message on things the player can't sell.
    protected transient String messageNoBuy;  /// The message shown when the player tries to buy. If null, buying is fine.
    protected transient String messageNoSell;  /// The message shown when the player tries to sell. If null, selling is fine.
    protected transient Map<Limit, String> messagesMap;  /// The map of messages given when a transaction is limited.
    protected transient Map<String, String> displayNamesMap;  /// The map of display names for Ids with no name themselves (e.g. tags, demand categories).
    protected transient Map<Limit, Set<String>> limitMap;  /// The map of parameters for each limit category.
    ...
    public @Nullable String getId() {
        if (getSubmarket() != null) { return getSubmarket().getSpecId(); }
        return null;
    }
