...
public class MissionDefinition implements MissionDefinitionPlugin {
	public void defineMission(MissionDefinitionAPI api) {
        ...
        api.addNebula(minX + width * 0.8f - 2000, minY + height * 0.4f, 2000f);
        api.addNebula(minX + width * 0.8f - 2000, minY + height * 0.5f, 2000f);
        api.addNebula(minX + width * 0.8f - 2000, minY + height * 0.6f, 2000f);
