...
public class tstHP_Heliopause extends BaseCommandPlugin {
    ...
    public static final float VALUE_TO_REP_MULT = 0.0001f;          /// So a 50k value hyperspace topology = 5 rep
    public static final float VALUE_TO_PROGRESS_MULT = 0.0005f;     /// So a 50k value hyperspace topology = 25 progress

    public static final String ADD_DATA = "addData";                /// Command for adding one-off data donations
    public static final String CAN_SELL_DATA = "canSellData";       /// Command to see if the player can bulk sell data
    public static final String SELL_DATA = "sellData";              /// Command to actually bulk-sell data
    public static final String NEXT_RULE = "toasterHPCEOSoldData";  /// The rule triggered once the sell window shuts
    public static final String BOUNTY_TAG = "$bountyValue";        /// The tag used to store the value of items sold
...
//    protected static final Logger log = Global.getLogger(tstHP_Heliopause.class);
     ...
     */
    public static float getStackValue(CargoStackAPI stack) { return stack.getBaseValuePerUnit() * stack.getSize(); }
