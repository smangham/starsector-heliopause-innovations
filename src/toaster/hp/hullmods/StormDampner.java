...
public class StormDampner implements HullModEffect {
    ...
    public static final String KEY = "$" + Tags.STORM_DAMPNER;
    /// The memory key for a fleet with a storm dampner.
    public static final String TAG = Tags.STORM_DAMPNER;
    /// The tag for a ship with a storm dampner.
