 ...
 *
 */
public class GhostSwarmAI implements ShipAIPlugin {
...
//		return ship != null && ship.getVariant().getHullVariantId().equals(Variants.GHOST_SWARM_LIGHTNING);
//	}
...
//	private ThreatShipConstructionScript constructionScript;
	...
	public GhostSwarmAI(ShipAPI ship) {
		this.ship = ship;
...
//		}
		...
		if (swarm != null && swarm.params.flockingClass != null && swarm.attachedTo != null) {
			for (GhostRoilingSwarmEffect curr : GhostRoilingSwarmEffect.getFlockingMap().getList(swarm.params.flockingClass)) {
