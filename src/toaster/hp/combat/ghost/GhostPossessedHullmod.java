...
import toaster.hp.combat.ghost.GhostRoilingSwarmEffect;
import toaster.hp.combat.ghost.GhostRoilingSwarmEffect.GhostRoilingSwarmParams;
 ...
 *
 */
public class GhostPossessedHullmod extends BaseHullMod {
    ...
    public void advanceInCombat(ShipAPI ship, float amount) {
        ...
        GhostRoilingSwarmEffect swarm = GhostRoilingSwarmEffect.getSwarmFor(ship);
        if (swarm == null) {
        ...
        GhostRoilingSwarmParams params = swarm.params;
...
//		}
    ...
    public static GhostRoilingSwarmEffect createSwarmFor(ShipAPI ship) {
        GhostRoilingSwarmEffect existing = GhostRoilingSwarmEffect.getSwarmFor(ship);
...
//		}
        ...
        GhostRoilingSwarmParams params = new GhostRoilingSwarmParams();
        if (ship.isFighter()) {
            float radius = 20f;
            int numMembers = 50;
            ...
            params.flockingClass = com.fs.starfarer.api.impl.combat.threat.FragmentSwarmHullmod.STANDARD_SWARM_FLOCKING_CLASS;
...
//		}
        ...
        return new GhostRoilingSwarmEffect(ship, params) {
