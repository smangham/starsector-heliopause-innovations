...
public class AttractorFieldAI implements ShipSystemAIScript {
    ...
    /// The ship with the AI.
    protected CombatEngineAPI engine;
    /// The combat engine.
    protected ShipwideAIFlags flags;
    /// The ship's general AI flags.
    protected ShipSystemAPI system;
    /// The ship system this AI is for.

    // Variables set during actual loops.
    protected IntervalUtil tracker = new IntervalUtil(0.5f, 1f);
    /// Used to space assessment.
    protected boolean shouldTrigger = false;
    /// Whether the system should be triggered
